...
public class AppInitializer extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        try {
            ...
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/thogakade/view/MainForm.fxml"));
    ...
    public static void navigateToHome(Node node, Stage mainStage) {
        ...
        Platform.runLater(()->{
            ...
            try {
                Parent root = FXMLLoader.load(AppInitializer.class.getResource("/lk/ijse/thogakade/view/MainForm.fxml"));
                Scene mainScene = new Scene(root);
